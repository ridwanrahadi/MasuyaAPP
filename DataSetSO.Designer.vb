...
Partial Public Class DataSetSO
    ...
    Partial Public Class DataTable1DataTable
        ...
        Public Overloads Function AddDataTable1Row( _
                    ...
                    ByVal proses_by As String) As DataTable1Row
            Dim rowDataTable1Row As DataTable1Row = CType(Me.NewRow,DataTable1Row)
            Dim columnValuesArray() As Object = New Object() {no_so, tgl_so, jam, kd_cust, no_po, grandtotal, keterangan, kd_user, approved, keterangan2, batal, proses, item_barang, harga, disc, disc2, disc3, jumlah, subtotal, satuan, NMSALES, NmCust, NmBrg, proses_by}
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        salesorder.no_so, salesorder.tgl_so, salesorder.jam, salesorder.kd_"& _ 
                ...
                "salesorder.proses_by"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            salesorder INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "      salesorder_item ON salesorder.no_so = salesorder_item.no_so INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                       tblCustomer ON salesorder.kd_cust = tblCustomer.KdCust IN"& _ 
                "NER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         tblIvMst ON salesorder_item.item_barang = tbl"& _ 
                "IvMst.KdBrg INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         tblSalesPerson ON salesorder.kd"& _ 
                "_user = tblSalesPerson.KDSALES"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSetSO.DataTable1DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSetSO.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSetSO.DataTable1DataTable = New DataSetSO.DataTable1DataTable()
